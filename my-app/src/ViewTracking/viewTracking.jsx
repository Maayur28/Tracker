...
import { Table, Row, Col, Spinner, Modal, Button,Image} from "react-bootstrap";
  ...
  return (
    <>
      <div className="viewTracking">
        ...
        ):<div style={{display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center',height:'60vh'}}><Image src="/emptyCart.gif" fluid /><h4>Nothing found! Please add to view trackings</h4> </div> : (
          <div
            style={{
              display: "flex",
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title className="deleteTitle">
              <h4 className="deleteTitle-h4" style={{ fontWeight: "bolder" }}>
                Remove Tracking
              </h4>
            </Modal.Title>
          </Modal.Header>
          <Modal.Body className="deleteBody">
            ...
            <h6 className="deleteBody-h6" style={{ color: "rgb(220,53,69)" }}>
          ...
          >
            <Button variant="outline-dark" onClick={() => setdeleteShow(false)}>
              Cancel
            </Button>
            <Button variant="outline-danger" onClick={confirmDelete}>
              {deleteReturned?<Spinner
                as="span"
                animation="grow"
                size="sm"
                role="status"
